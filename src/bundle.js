...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameArea = __webpack_require__(1);
	...
	var Boat = function (_BaseComponent) {
	    ...
	    _createClass(Boat, [{
	        ...
	        value: function update() {
	            var lastKeyPressed = _underscore2.default.last(keysPressed);
	        ...
	        value: function bindKeys() {
	            window.addEventListener('keydown', function (e) {
	                if (!_underscore2.default.contains(keysPressed, e.keyCode)) keysPressed.push(e.keyCode);
	            });

	            window.addEventListener('keyup', function (e) {
	                var index = _underscore2.default.indexOf(keysPressed, e.keyCode);
