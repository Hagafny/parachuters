...
(function () {
    function Plane(settings) {
        ...
        settings.x = getNewPlaneLocation.call(this); //Override inital X. The plane will start from a random point to the right of the canvas. This is why we need to recalculate the x.
        ...
        this.update = function () {
            ...
            //If the plane didn't finishe a cycle, move left.
            if (hasFinishedCycle.call(this)) {
                deploymentXLocations = [];
                restartPlaneLocation.call(this);
                setDeploymentLocations.call(this);
            }
            else
                moveLeft.call(this);
