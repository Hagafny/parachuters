...
(function () {
    var GameManager = function () {
        // Properties
        var gameArea, background, water, boat, plane, parachuters = [], lifeText, scoreText, gameLoop;
        ...
        function createComponents() {
            ...
            var waterSettings = { width: canvasDimensions.width, height: canvasDimensions.height / 5, x: 0, img: "img/water.jpg" };
            ...
            var boatSettings = { width: 80, height: 50, img: "img/boat.png", canvasDimensions: canvasDimensions };
        ...
        // Stop the game when it's game over. This will make the screen freaze.
        function stopGame() {
